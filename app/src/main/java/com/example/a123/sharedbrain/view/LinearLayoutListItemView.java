...
public class LinearLayoutListItemView extends LinearLayout implements View.OnClickListener {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        @SuppressLint({"CustomViewStyleable", "Recycle"}) TypedArray array = context.obtainStyledAttributes(attrs, R.styleable.LinearLayoutListItemViewStyle);
        ...
        LinearLayout mView_Body = (LinearLayout) viewRoot.findViewById(R.id.mView_Body);
        ...
        int mLeftTextFontColor = array.getColor(R.styleable.LinearLayoutListItemViewStyle_text_left_fontcolor, -1);
        int mLeftText2FontColor = array.getColor(R.styleable.LinearLayoutListItemViewStyle_text_left2_fontcolor, -1);
        ...
        int mLeftTextFontSize = array.getInt(R.styleable.LinearLayoutListItemViewStyle_text_left_fontsize, -1);
        ...
        boolean mClickable = array.getBoolean(R.styleable.LinearLayoutListItemViewStyle_clickable, false);
...
//		mList_Item_Image_Size = DisplayMetrics.dip2px(mContext, array.getInt(R.styleable.LinearLayoutListItemViewStyle_list_item_image_size, -1));
        ...
        //Item高度
        int mList_Item_Height = array.getInt(R.styleable.LinearLayoutListItemViewStyle_list_item_height, -1);
        //左侧头像尺寸
        int mList_Item_Image_Size = array.getInt(R.styleable.LinearLayoutListItemViewStyle_list_item_image_size, -1);
        ...
        if(mView_Body != null && mList_Item_Height != -1){
            ...
            params.height = ScreenUtil.dp2px(Objects.requireNonNull(App.getAppContext()), mList_Item_Height);
        ...
        switch (mListItem_Style) {
            case LIST_ITEM_STYLE_LISTITEM_TEXT:
                ...
                if (mTv_LeftText != null) {
                    ...
                    if(mLeftText_MarginLeft != -1){
                        ...
                        params.setMargins(ScreenUtil.dp2px(Objects.requireNonNull(App.getAppContext()),mLeftText_MarginLeft), params.topMargin, params.rightMargin, params.bottomMargin);
                        mTv_LeftText .setLayoutParams(params);
                    }
                    if (mLeftText_MarginRight != -1) {
                        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)mTv_LeftText.getLayoutParams();
                        params.setMargins(params.leftMargin, params.topMargin, ScreenUtil.dp2px(Objects.requireNonNull(App.getAppContext()),mLeftText_MarginRight), params.bottomMargin);
                        mTv_LeftText .setLayoutParams(params);
                    }
                }
                ...
                if (mTv_LeftText2 != null) {
                    ...
                    if (mLeft2Text_MarginLeft != -1) {
                        ...
                        params.setMargins(ScreenUtil.dp2px(Objects.requireNonNull(App.getAppContext()),mLeft2Text_MarginLeft), params.topMargin, params.rightMargin, params.bottomMargin);
                        mTv_LeftText2 .setLayoutParams(params);
                    }
                    if (mLeft2Text_MarginRight != -1) {
                        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)mTv_LeftText2.getLayoutParams();
                        params.setMargins(params.leftMargin, params.topMargin, ScreenUtil.dp2px(Objects.requireNonNull(App.getAppContext()),mLeft2Text_MarginRight), params.bottomMargin);
                        mTv_LeftText2 .setLayoutParams(params);
                    }

                    if (mLeft2TextSingleLine) {
                        mTv_LeftText2.setSingleLine(true);
                        mTv_LeftText2.setEllipsize(TextUtils.TruncateAt.END);
                    }
                }
                ...
                if (mTv_RightText != null) {
                    ...
                    if(mRightTextBackground != null){
                        ...
                        mTv_RightText.setBackground(mRightTextBackground);
                    }
                    ...
                    if (mRightTextSingleLine) {
                        ...
                        mTv_RightText.setEllipsize(TextUtils.TruncateAt.END);
                    }
                }
            ...
            case LIST_ITEM_STYLE_LISTITEM_MENU:
                ...
                if (mTv_LeftText != null) {
                    ...
                    if(mLeftText_MarginLeft != -1){
                        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)mTv_LeftText.getLayoutParams();
                        params.setMargins(ScreenUtil.dp2px(Objects.requireNonNull(App.getAppContext()),mLeftText_MarginLeft), params.topMargin, params.rightMargin, params.bottomMargin);// 通过自定义坐标来放置你的控件
                        mTv_LeftText.setLayoutParams(params);
                    }
                    if (mLeftText_MarginRight != -1) {
                        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)mTv_LeftText.getLayoutParams();
    ...
    public void setLeftIconSize(int size){
        if(mIv_LeftIcon != null && size != -1){
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams)mIv_LeftIcon.getLayoutParams();
            params.width = ScreenUtil.dp2px(Objects.requireNonNull(App.getAppContext()),size);
    ...
    public void setLeftTextMaxEms(int value){
        if(value != -1){
            ...
            mTv_LeftText.setEllipsize(TextUtils.TruncateAt.END);
        }
    }
    ...
    public void setLeftTextMaxEms(int value, boolean singleLine, boolean middle){
        if(value != -1){
            ...
            if (middle) {
                mTv_LeftText.setEllipsize(TextUtils.TruncateAt.MIDDLE);
            } else {
                mTv_LeftText.setEllipsize(TextUtils.TruncateAt.END);
            }
        }
...
//		}
    ...
    public void setRightText2MaxEms(int value){
        if(value != -1){
            ...
            mTv_RightText2.setEllipsize(TextUtils.TruncateAt.END);
        }
    }
    ...
    public void setRightText3MaxEms(int value){
        if(value != -1){
            ...
            mTv_RightText3.setEllipsize(TextUtils.TruncateAt.END);
        }
    }
    ...
    public void setBottomTextMaxEms(int value){
        if(value != -1){
            ...
            mTv_BottomText.setEllipsize(TextUtils.TruncateAt.END);
        }
    }
    ...
    public void setLeftText_MarginLeft(int value) {
        if (value != -1) {
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mTv_LeftText.getLayoutParams();
            params.setMargins(ScreenUtil.dp2px(Objects.requireNonNull(App.getAppContext()),value), params.topMargin, params.rightMargin, params.bottomMargin);// 通过自定义坐标来放置你的控件
            mTv_LeftText.setLayoutParams(params);
        }
    }
    ...
    public void setLeftText_MarginRight(int value) {
        if (value != -1) {
            RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) mTv_LeftText.getLayoutParams();
            params.setMargins(params.leftMargin, params.topMargin, ScreenUtil.dp2px(Objects.requireNonNull(App.getAppContext()),value), params.bottomMargin);// 通过自定义坐标来放置你的控件
            mTv_LeftText.setLayoutParams(params);
        }
    }
    ...
    public void setLeftTextIcon(int drawable_res) {
        ...
        Drawable drawable = ResourcesCompat.getDrawable(getResources(), drawable_res, null);
