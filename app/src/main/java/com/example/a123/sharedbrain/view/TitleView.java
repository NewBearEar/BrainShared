...
import com.example.a123.sharedbrain.utils.DisplayMetricsUtil;
...
public class TitleView extends FrameLayout {
     ...
     * 设置左侧按钮为Finish按钮
     * */
    public void setLeftButtonAsFinish(final AppCompatActivity a) {
        showView(0, 0);
        mLeftText.setText("\ue60c");
     ...
     * 设置左侧按钮为Finish白色按钮
     * */
    public void setLeftButtonAsFinishWhite(final AppCompatActivity a) {
        showView(0, 0);
        mLeftText.setText("\ue60c");
    ...
    public void setRightButtonTextColorBg(Drawable drawable) {
        mRightText.setBackground(drawable);
    }
    ...
    protected void onFinishInflate() {
        ...
        mLeftText.setTextColor(ContextCompat.getColor(getContext(),R.color.white1));
        ...
        mCenterText.setTextColor(ContextCompat.getColor(getContext(),R.color.white1));
        ...
        mRightText.setTextColor(ContextCompat.getColor(getContext(),R.color.white1));
        ...
        rootLayout.setBackgroundColor(ContextCompat.getColor(mContext,R.color.main_bg_color1));
