...
//    }
     ...
     * @param infoType  信息类型 1 订单 2 博客 3 动态
     * @param start     信息从第几行开始提取
     * @param count     信息数目   这里一次获取10条  需要更多获取联系后台
     * @param callback  回调
     */
//    public void getNoticeAsync(int MajorId,String username, int infoType,int start, int count,int lastId, JsonCallback<LslResponse<List<InfoModel>>> callback){
//        String url = Consts.API_SERVICE_HOST+"/info/info_main.php?MajorId="+MajorId+
...
//    }
     ...
     * @param callback  回调
     */
//    public void getUserInfoAsync(String username, JsonCallback<LslResponse<UserInfoModel>> callback){
...
//    }
     ...
     * @param callback      回调
     */
//    public void addMainInfoAsync(int MajorId, String username, int infoType, String content, List<String> picUrls,boolean isVideo, JsonCallback<LslResponse<InfoModel>> callback){
//        String url = Consts.API_SERVICE_HOST+"/info/add_main.php";
//        HashMap<String,String> postParams = new HashMap<>();
//        postParams.put("MajorId",MajorId+"");
//        postParams.put("username",username);
...
//    }
     ...
     * @param callback  回调
     */
//    public void sendMsgToOthersAsync(int MajorId,int infoType,JsonCallback<LslResponse<Object>> callback){
//        String url = Consts.API_SERVICE_HOST+"/android_example.php?classId="+MajorId+"&infoType="+infoType;
//        OkGo.get(url);//.execute(callback);
//    }
