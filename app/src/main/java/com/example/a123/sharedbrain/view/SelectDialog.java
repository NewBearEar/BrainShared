...
public class SelectDialog extends Dialog implements OnClickListener,OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        View view = getLayoutInflater().inflate(R.layout.view_dialog_select,
                null);
        setContentView(view, new ViewGroup.LayoutParams(LayoutParams.FILL_PARENT,
    ...
    private class DialogAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (!mUseCustomColor) {
                mFirstItemColor = mActivity.getColor(R.color.dialog_blue);
                mOtherItemColor = mActivity.getColor(R.color.dialog_blue);
            }
            if (1 == mStrings.size()) {
