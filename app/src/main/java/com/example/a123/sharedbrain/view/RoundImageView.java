...
public class RoundImageView extends AppCompatImageView{
    ...
    private static class imageview_level {
        ...
        final static int level3 = 3;
        final static int level4 = 4;
    }
    ...
    private void setCustomAttributes(AttributeSet attrs) {
        @SuppressLint("Recycle") TypedArray a = mContext.obtainStyledAttributes(attrs, R.styleable.roundedimageview);
